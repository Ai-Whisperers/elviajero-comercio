  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {hasStock && (
          <div className={`absolute inset-x-0 bottom-0 z-20 flex gap-1 p-2 transition-all duration-200 ${
            isHovered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"
          }`}>
            <button
              onClick={handleAdd}
              className="flex flex-1 items-center justify-center gap-1 rounded-lg bg-primary py-2 text-[11px] font-semibold text-primary-foreground shadow-sm transition-all hover:bg-primary/90 active:scale-[0.97]"
            >
            ...
            <a
              ...
              className="flex flex-1 items-center justify-center gap-1 rounded-lg bg-green-600 py-2 text-[11px] font-semibold text-white shadow-sm transition-all hover:bg-green-700 active:scale-[0.97]"
            >
