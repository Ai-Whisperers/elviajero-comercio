    ...
    >
      ...
      >
        ...
        <button
          ...
          aria-label={isWished(product.name) ? (s.removeFav || "Quitar de favoritos") : (s.addFav || "Agregar a favoritos")}
        >
      ...
      <div className="flex flex-1 flex-col gap-2 p-4">
        ...
        >
          ...
          {hasStock ? (s.add || "Agregar") : (s.soldOut || "Agotado")}
        </button>
      </div>
    </div>
  )
