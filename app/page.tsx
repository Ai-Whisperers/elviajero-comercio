...
function HomePage() {
  ...
  return (
    <>
      ...
      {categories.length > 0 && <section className="bg-background py-16"><div className="mx-auto max-w-7xl px-4"><h2 className="mb-6 text-center text-3xl font-bold text-foreground">{h.productCatalog?.title}</h2><div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-6">{categories.map((cat: string, i: number) => (
