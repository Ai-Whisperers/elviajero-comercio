        ...
        <div className="rounded-xl border border-zinc-800/60 bg-zinc-900/50 p-6">
          {section === "general" && (
            <div className="space-y-4">
              <Input label="Nombre del sitio" value={get("siteName") || ''} onChange={v => set("siteName", v)} placeholder="El Viajero" />
              <Input label="Razón social" value={get("businessName") || ''} onChange={v => set("businessName", v)} placeholder="Tienda El Viajero" />
              <Input label="Tagline" value={get("tagline") || ''} onChange={v => set("tagline", v)} placeholder="Equipamiento para aventura" />
              <Input label="WhatsApp number" value={get("whatsapp.number") || ''} onChange={v => set("whatsapp.number", v)} placeholder="595984009751" />
                ...
                return slides.map((_: any, i: number) => {
                  ...
                  return (
                    <div key={i} className="rounded-lg border border-zinc-700/60 bg-zinc-800/50 p-4">
                      ...
                      <Input label="Título" value={s.title || ""} onChange={v => setSlideField(i, "title", v)} placeholder="" />
                      <Input label="Subtítulo" multiline value={s.subtitle || ""} onChange={v => setSlideField(i, "subtitle", v)} placeholder="" />
                      <ImageUpload label={`Imagen de fondo ${i + 1}`} currentUrl={s.image || undefined} onUpload={v => setSlideField(i, "image", v)} />
                      <Input label="Texto botón" value={s.ctaText || ""} onChange={v => setSlideField(i, "ctaText", v)} placeholder="" />
                      <Input label="Link botón" value={s.ctaHref || ""} onChange={v => setSlideField(i, "ctaHref", v)} placeholder="" />
                    </div>
                  )
                })
              })()}
                        ...
                        {subs.map((sub: any, si: number) => (
                          <div key={si} className="flex items-center gap-2 mb-2">
                            <input
                              value={sub.name || ""}
                              onChange={e => {
                                const current = deepGetRaw(overrides, `home.productCatalog.subcategories.${slug}`) as any[] || []
          ...
          {section === "about" && (
            <div className="space-y-4">
              <Input label="Título" value={get("about.hero.title") || ''} onChange={v => set("about.hero.title", v)} placeholder={"Sobre Nosotros"} />
              <Input label="Subtítulo" multiline value={get("about.hero.subtitle") || ''} onChange={v => set("about.hero.subtitle", v)} placeholder={"Tu aventura comienza aquí"} />
              <div>
          ...
          {section === "kits" && (
            <div>
              ...
              <Input label="Título de la sección" value={get("home.kitsCarousel.title") || ''} onChange={v => set("home.kitsCarousel.title", v)} placeholder={" kits destacados"} />
              {(getArray("home.kitsCarousel.items").length > 0 ? getArray("home.kitsCarousel.items") : defaultContent.home?.kitsCarousel?.items || []).map((item: any, i: number) => (
                <div key={i} className="mb-4 rounded-lg border border-zinc-700/60 bg-zinc-800 p-4">
                  <Input label={`Título ${i + 1}`} value={item.title || ""} onChange={v => updateArrayItem("home.kitsCarousel.items", i, "title", v)} placeholder="Kit" />
          ...
          {section === "contacto" && (
            <div className="space-y-4">
              <Input label="Dirección" value={get("contacto.info.address") || ''} onChange={v => set("contacto.info.address", v)} placeholder={"Asunción, Paraguay"} />
              <Input label="Teléfono" value={get("contacto.info.phone") || ''} onChange={v => set("contacto.info.phone", v)} placeholder={""} />
              <Input label="Email" value={get("contacto.info.email") || ''} onChange={v => set("contacto.info.email", v)} placeholder={""} />
              <Input label="Horarios" value={get("contacto.info.hours") || ''} onChange={v => set("contacto.info.hours", v)} placeholder={""} />
            </div>
          )}
          ...
          {section === "footer" && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Input label="Razón social" value={get("businessName") || ''} onChange={v => set("businessName", v)} placeholder={"Tienda El Viajero"} />
                <Input label="Descripción" multiline value={get("footer.description") || ''} onChange={v => set("footer.description", v)} placeholder={""} />
                <Input label="Dirección" value={get("footer.address") || ''} onChange={v => set("footer.address", v)} placeholder={""} />
                <Input label="Teléfono" value={get("footer.phone") || ''} onChange={v => set("footer.phone", v)} placeholder={""} />
                <Input label="Horarios" value={get("footer.hours") || ''} onChange={v => set("footer.hours", v)} placeholder={""} />
              </div>
          ...
          {section === "faq" && (
            <div>
              <Input label="Título de sección FAQ" value={get("faq.hero.headline") || ''} onChange={v => set("faq.hero.headline", v)} placeholder={""} />
              <Input label="Subtítulo FAQ" value={get("faq.hero.subheadline") || ''} onChange={v => set("faq.hero.subheadline", v)} placeholder={""} />
              <div className="mt-6">
          ...
          {section === "stats" && (
            <div>
              ...
              <Input label="Título de la sección" value={get("home.stats.title") || ''} onChange={v => set("home.stats.title", v)} placeholder={""} />
          ...
          {section === "seo" && (
            <div className="space-y-4">
              ...
              <Input label="Home: Title" value={get("home.seo.title") || ''} onChange={v => set("home.seo.title", v)} placeholder={""} />
              <Input label="Home: Description" multiline value={get("home.seo.description") || ''} onChange={v => set("home.seo.description", v)} placeholder={""} />
              <Input label="Tienda: Title" value={get("tienda.seo.title") || ''} onChange={v => set("tienda.seo.title", v)} placeholder={""} />
              <Input label="Tienda: Description" multiline value={get("tienda.seo.description") || ''} onChange={v => set("tienda.seo.description", v)} placeholder={""} />
              <Input label="Blog: Title" value={get("blog.title") || ''} onChange={v => set("blog.title", v)} placeholder={""} />
              <Input label="Blog: Subtitle" value={get("blog.subtitle") || ''} onChange={v => set("blog.subtitle", v)} placeholder={""} />
              <Input label="Nosotros: Title" value={get("about.seo.title") || ''} onChange={v => set("about.seo.title", v)} placeholder={""} />
              <Input label="Nosotros: Description" multiline value={get("about.seo.description") || ''} onChange={v => set("about.seo.description", v)} placeholder={""} />
              <Input label="Contacto: Title" value={get("contacto.seo.title") || ''} onChange={v => set("contacto.seo.title", v)} placeholder={""} />
              <Input label="Contacto: Description" multiline value={get("contacto.seo.description") || ''} onChange={v => set("contacto.seo.description", v)} placeholder={""} />
            </div>
          )}
          ...
          {section === "features" && (
            <div>
              ...
              <Input label="Título de la sección" value={get("home.features.title") || ''} onChange={v => set("home.features.title", v)} placeholder={""} />
          ...
          {section === "promociones" && (
            <div>
              ...
              <Input label="Título" value={get("promociones.hero.headline") || ''} onChange={v => set("promociones.hero.headline", v)} placeholder={""} />
              <Input label="Subtítulo" value={get("promociones.hero.subheadline") || ''} onChange={v => set("promociones.hero.subheadline", v)} placeholder={""} />
